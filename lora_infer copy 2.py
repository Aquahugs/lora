...
init_image = Image.open("./init_image/s2r_render8.png").convert("RGB").resize((512, 512))
...
monkeypatch_lora(pipe.unet, torch.load("./output/4k_product/lora_weight_e99_s71000.pt"))

prompt = "3d rendering of a christmas tree designed by <zwfwergfd>"
...
grid_image.save("./output/images/grid71.jpg", "JPEG")
