...
init_image = Image.open("./init_image/s2r_render2.png").convert("RGB").resize((512, 512))
...
monkeypatch_lora(pipe.unet, torch.load("./output/SRD_3x2_12_17_2022_A/lora_weight_e3999_s80000.pt"))

prompt = "<designsketchconceptrendering>"
